...
const AlertDialogProvider = ({ 
  ...
  return (
    <AlertDialog open={open} onOpenChange={handleOpenChange}>
      <AlertDialogTrigger onClick={() => setOpen(true)} disabled={disabled}>
        {children}
      </AlertDialogTrigger>
      <AlertDialogContent>
        <AlertDialogHeader>
        ...
        <AlertDialogFooter>
          <AlertDialogCancel disabled={isLoading}>
            {isLoading ? <LoaderCircle className="animate-spin" /> : "Cancel"}
          </AlertDialogCancel>
          {onConfirm && (
            <AlertDialogAction
              onClick={onConfirm} 
            ...
            >
              {isLoading ? <LoaderCircle className="animate-spin" /> : (textBtn ?? "Confirm")}
            </AlertDialogAction>
          )}
        </AlertDialogFooter>
      </AlertDialogContent>
